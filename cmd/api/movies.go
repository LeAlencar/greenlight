...
import (
	...
	"github.com/lealencar/greenlight/internal/data"
...
func (app *application) createMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Call the Insert() method on our movies model, passing in the validated
	// movie struct. This will create a record in the database and return an
	// updated copy of the movie struct containing the system-generated information.
